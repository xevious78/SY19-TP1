...
%opening
\title{SY19 - Machine Learning \\ First Assignment}
\author{Slam, Zineb \& Taleb, Aladin}
...
\begin{abstract}
This report is an assignment for the course SY19 : Machine Learning. It is focused on two exercises : a regression problem and classification problem. In each part, we will describe the methodology we used to build the best model for each dataset.

Since none of us have previously taken SY09, and only one of us has already done SY02, please note this report may lack some important explanations and analysis.
\end{abstract}
